<div class="bg-gray-50 min-h-screen">
    ...
    @php
        ...
        $announcementCard = 'bg-white rounded-xl border border-gray-100 shadow-sm p-4 space-y-3 hover:shadow-lg transition-shadow duration-300';
    @endphp
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                @forelse ($announcements as $announcement)
                    ...
                    <div class="{{ $announcementCard }}"
                        ...
                        {{-- Header: Icon, Description, No --}}
                        <div class="flex items-start justify-between">
                            <div class="flex items-start gap-3 flex-1 min-w-0">
                                <div class="{{ $ico }}">
                                    <x-heroicon-o-megaphone class="w-4 h-4 text-gray-900" />
                                </div>
